...
### Check feature PRDs for contract amendments

If feature PRDs exist in `docs/features/`, scan each for a "Contract Amendments" section. These are structured amendment proposals generated by the prd-feature-breakdown skill when it discovers gaps or mismatches in the contracts.

If amendments are found:
- Summarize them to the user: "I found contract amendment proposals in these feature PRDs: [list]"
- Present each amendment and ask the user whether to incorporate it
- Confirmed amendments become inputs to the relevant phase (entity amendments to Phase 1, API amendments to Phase 2, event amendments to Phase 3)
...
- "Your contracts are documented. Next steps you might consider:"
  ...
  - Run the prd-feature-breakdown skill if features haven't been decomposed yet
